...
#include "../srcFloat3/Consts.cuh"
#include "../srcFloat3/cuda_util.cuh"
#include "../srcFloat3/MathFloat3.cuh"
#include "../srcFloat3/Light.cuh"
#include "../srcFloat3/Sphere.cuh"
#include "../srcFloat3/Ray.cuh"
...
void run_kernel(const int pixels, float3* fb, Sphere* spheres, Light* light, float3* origin) {
  ...
  checkErrorsCuda(cudaMemcpy((void*) fb_device, fb, sizeof(float3) * pixels, cudaMemcpyHostToDevice));
